...
def insert_basic_funtion(sql,args):
    try:
        #   使用全局变量的时候要注意了
...
def insert_weibo(Weibo):
    ...
    args = (Weibo.mid,Weibo.content,Weibo.time,Weibo.timestamp,Weibo.extra,Weibo.forward_num,Weibo.comment_num,Weibo.like_num)
    insert_basic_funtion(sql,args)
